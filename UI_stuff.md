/**
 * ============================================================================
 * MASTER UI DESIGN SYSTEM - BASELINE TEMPLATE
 * ============================================================================
 *
 * Extracted from TutorMaxAI - A comprehensive design system featuring:
 * - Dark theme with warm accent colors
 * - Comprehensive animation library
 * - Gamification-ready components
 * - Educational interface patterns
 *
 * Author: Extracted for reuse across future projects
...
:root {
  ...
  --card-bg: #2a2a2a;              /* Card/container backgrounds */
  --border-color: #3a3a3a;         /* Default border color */

  /* ===== Accent Colors ===== */
  --accent: #d4a574;               /* Tan/gold primary accent */
  --accent-hover: #c49565;         /* Darker accent for hover states */
  ...
  /* Error */
  --error: #ef4444;                /* Red */
  --error-bg: #7f1d1d33;          /* Error background */
  --error-border: #ef444480;       /* Error border (50% opacity) */
...
body {
  ...
  font-family: 'Roboto Mono', monospace;  /* Monospace for technical aesthetic */
}
...
input:focus, textarea:focus, select:focus {
  transform: translateY(-1px);
  box-shadow: 0 4px 6px -1px rgba(212, 165, 116, 0.1),
              0 2px 4px -1px rgba(212, 165, 116, 0.06);
}
...
/* ===== Card Hover Effects ===== */
.card, [class*="bg-[#2a2a2a]"], [class*="bg-card"] {
...
/* ============================================================================
   8. KEYFRAME ANIMATIONS - GAMIFICATION & INTERACTIONS
   ============================================================================ */
...
/* ===== Explanation Message (Highlighted) ===== */
.message-explanation {
  background-color: rgba(212, 165, 116, 0.1);
  color: var(--accent);
